    ...
    onSubmit: async ({ value }) => {
      try {
        const response = await axios.post(
          `${import.meta.env.VITE_NEST_BASE_URL}/auth/login`,
          {
            email: value.email,
          ...
          <Card className="overflow-hidden p-0">
            <CardContent className="grid p-0 md:grid-cols-2">
              <div className="bg-muted relative hidden md:block">
                <img
                  src="https://images.unsplash.com/photo-1522444195799-478538b28823?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aG9tZXxlbnwwfHwwfHx8MA%3D%3D"
                  alt="Image"
              ...
              >
                <div className="flex flex-col gap-6">
                  ...
                  <Button
                    ...
                    disabled={!signupForm.state.isValid || signupForm.state.isSubmitting}
                  >
