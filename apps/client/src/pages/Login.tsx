...
export default function LoginForm({
  ...
  const loginForm = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      try {
        const response = await axios.post(`${import.meta.env.VITE_NEST_BASE_URL}/auth/login`, {
          email: value.email,
          ...
          <Card className="overflow-hidden p-0">
            <CardContent className="grid p-0 md:grid-cols-2">
              ...
              <div className="bg-muted relative hidden md:block">
                <img
                  src="https://plus.unsplash.com/premium_photo-1689609950112-d66095626efb?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aG9tZXxlbnwwfHwwfHx8MA%3D%3D"
                  alt="Image"
